    ...
    class FirstPerson():
        ...
        def Update(self):
            ...
            if self.CarCrashed: # If yes, bring camera position near ideal 
                ...
                self.camera.setPos( ChassisPos.getX()  +  (7 + self.BringNear ) * MiscFunctions.Truncate(self, sin((ChassisHPR.getX()+self.CamOffset)*(pi/180)), 5)  ,
                                    ChassisPos.getY()  -  (7 + self.BringNear ) * MiscFunctions.Truncate(self, cos((ChassisHPR.getX()+self.CamOffset)*(pi/180)), 5)  ,
                ...
                if self.Vehicle.getCurrentSpeedKmHour() < 100:
                    self.camera.setPos( ChassisPos.getX()  +  (7 + (1*self.Vehicle.getCurrentSpeedKmHour()/100) + self.BringNear) * MiscFunctions.Truncate(self, sin((ChassisHPR.getX()+self.CamOffset)*(pi/180)), 5)  ,
                                        ChassisPos.getY()  -  (7 + (1*self.Vehicle.getCurrentSpeedKmHour()/100) + self.BringNear) * MiscFunctions.Truncate(self, cos((ChassisHPR.getX()+self.CamOffset)*(pi/180)), 5)  ,
                                        ChassisPos.getZ()  -  2.5 * MiscFunctions.Truncate(self, sin(ChassisHPR.getY()*(pi/180)), 5)+0.7
                    )
                else:
                    self.camera.setPos( ChassisPos.getX()  +  (8 + self.BringNear) * MiscFunctions.Truncate(self, sin((ChassisHPR.getX()+self.CamOffset)*(pi/180)), 5)  , 
                                        ChassisPos.getY()  -  (8 + self.BringNear) * MiscFunctions.Truncate(self, cos((ChassisHPR.getX()+self.CamOffset)*(pi/180)), 5)  , 
                                        ChassisPos.getZ()  -  2.5 * MiscFunctions.Truncate(self, sin(ChassisHPR.getY()*(pi/180)), 5)+0.7
                    )
